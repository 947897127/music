    ...
    <transition name="normal" @enter="enter" @afterEnter="afterEnter" @leave="leave" @afterLeave="afterLeave">
      <div class="normal-player" v-show="fullScreen">
          ...
          <div class="middle" @touchstart.prevent="middleTouchStart" @touchmove.prevent="middleTouchMove" @touchend.prevent="middleTouchEnd">
              <div class="middle-l" ref="middeL">
                  <div class="cd-wrapper" ref="cdWrapper">
                      <div class="cd" :class="caCls">
          ...
          <div class="operators">
              <div class="icon i-left" @click="iconChanger">
                  <i :class="iconMode"></i>
              </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
          <div class="icon">
              <img :class="caCls" width="40" height="40" :src="currentSong.image" alt="">
          </div>
          <div class="text">
      ...
      created(){
        ...
        methods:{
            ...
            onProgressBarChange(percent){ 
              ...
              if(this.currentLyric0){
                this.currentLyric.ceek(currentTime * 1000)
              }
            },
            iconChanger(){
            ...
            middleTouchMove(e){
              ...
              this.$refs.middeL.style.opacity = 1 - this.touch.percent
              this.$refs.middeL.style[transitionDuration] = 0
            },
            middleTouchEnd(){
              let width
              let opacity
              ...
              this.$refs.middeL.style.opacity = opacity
              this.$refs.middeL.style[transitionDuration] = `${time}ms`
            },
            _pad(num,n = 2){
